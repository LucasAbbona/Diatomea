...
const Footer = () => {
    return (
        <div className='w-full bg-primary-darkGrey flex flex-col py-10 gap-5 items-center relative overflow-hidden'>
                ...
                <button className='text-black px-6 py-3 text-sm font-medium rounded-md bg-bg-page shadow-sm shadow-primary-darkGrey'>Políticas de cambio y devolución</button>
